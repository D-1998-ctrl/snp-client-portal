...
const createAccount = async (e) => {
    ...
    if (email === "") {
        ...
        const url = 'http://127.0.0.1:8880/common/user/email/getuserbyemail/';
        console.log(url)
        fetch(url + email, requestOptions)
            ...
            .then((result) => {
                ...
                if (result.user.length > 0) {
                    ...
                    // Fetch URL with environment variable
                    const url = "http://127.0.0.1:8880/clientrequest-otp/";
                    let config = {
                        method: "post",
...
const [otp, setOtp] = useState("");
 ...
 const sendOtpVerify = async (e) => {
    ...
    if (otp === "") {
        ...
        const url = 'http://127.0.0.1:8880/verifyclient-otp/';
...
const clientalldata = () => {
    ...
    console.log(raw)
    const url = "http://127.0.0.1:8880/admin/clientsignup/";
...
const clientCreatedmail = () => {
    ...
    const urlusersavedmail ='http://127.0.0.1:8880/clientsavedemail/';
...
const handleaccountSubmit = () => {
   ...
   const url = "http://127.0.0.1:8880/accountdetails/";
